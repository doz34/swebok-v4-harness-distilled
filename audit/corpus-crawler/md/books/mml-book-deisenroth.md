...
[View the Project on GitHub](https://github.com/mml-book/mml-book.github.io)

- [View On **GitHub**](https://github.com/mml-book/mml-book.github.io)
...
- [PDF of the book](/book/mml-book.pdf). This version is the most up-to-date version of the book, i.e., we continue fixing typos etc.
- Additional Chapters (not part of the official book) [Modern Integration Methods](/book/additional_chapters/integration-methods.pdf)
...
- [PDF of the printed book](/book/mml-book_printed.pdf) This version is equivalent (modulo formatting) with the printed version of the book. GitHub issues starting from 433 are not included in this version.
...
- Jupyter notebook tutorials (for learning) [Linear Regression](https://nbviewer.jupyter.org/github/mml-book/mml-book.github.io/blob/master/tutorials/tutorial_linear_regression.ipynb) [PCA](https://nbviewer.jupyter.org/github/mml-book/mml-book.github.io/blob/master/tutorials/tutorial_pca.ipynb) [Gaussian Mixture Models](https://nbviewer.jupyter.org/github/mml-book/mml-book.github.io/blob/master/tutorials/tutorial_gmm.ipynb) SVM (work in progress)
- Jupyter notebook tutorials (solutions) [Linear Regression](/tutorials/tutorial_linear_regression.solution.ipynb) [PCA](/tutorials/tutorial_pca.solution.ipynb) [Gaussian Mixture Models](/tutorials/tutorial_gmm.solution.ipynb) SVM (work in progress)
