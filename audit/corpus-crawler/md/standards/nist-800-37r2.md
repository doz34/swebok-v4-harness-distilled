...
This publication contains comprehensive updates to the JOINT TASK FORCE
...
assets, individuals, other organizations, and the Nation. This publication is available free of charge from:
...
This publication is available free of charge from:
https://doi.org/10.6028/NIST.SP.800-37r2
Certain commercial entities, equipment, or materi als may be identified in this document to describe
an experimental procedure or concept adequately. Such identification is not intended to imply
recommendation or endorsement by NIST, nor is it intended to imply that the entities, materials, or
equipment are necessarily the best available for th e purpose.
There may be references in this publication to oth er publications currently under development by
...
completion of such companion publications. Thu s, until each publication is completed, current
...
Organizations are encouraged to review draft pub lications during the designated public comment
...
Publication 800-37 since its inception in 2005. They include Marshall Abrams, William Barker,
Beckie Koonge, Roger Caslow, John Gilligan, Peter Gouldmann, Richard Graubart, John Grimes,
...
management process but rather a tailored set of controls and specific implementation details
...
the Cybersecurity Framework might find value in using the RMF as a risk management process
...
Executive Order (E.O.) 13800 requires federal ag encies to modernize their IT infrastructure and
systems and recognizes the increasing interconn ectedness of federal information systems and
networks. The E.O. also requires heads of agenci es to manage risk at the agency level and across
...
Modernization Act (FISMA) of 2014 by holding heads of agencies responsible and accountable
...
Framework Profiles, aligns with the Cybersecurity Framework Profile construct; and Task R-5,
...
of effort. The objective is to ensure that security and privacy requirements derived from laws,
...
O r ganizations depend on information systems1 to carry out their missions and business
...
LEVE L ONE
COMMUNICATION ORGANIZATION RISK MANAGEMENT
AND REPORTING
ACROSS LEVELS
LEVEL TWO
...
LEVEL THREE
INFORMATI ON SYSTEM
More detailed and gra nular risk perspective.
...
protect the systems that organizations depend on for mission and business success and the
...
a proposed step and task entry into the RMF, a gap analysis to ensure that the risk is acceptable, documenting
...
IMPACT-LEVEL PRIORITIZATION impact le vel is conducted.
(OPTIONAL) [Cyberse curity Framework: ID.AM-5]
TASK P-7 • An organ ization-wide strategy for monitoring control
CONTINUOUS MONITORING STRATEGY— effective ness is developed and implemented.
ORGANIZATION [Cyberse curity Framework: DE.CM; ID.SC-4]
Quick link to summary table for RMF task s, responsibilities, and supporting roles.
...
Task TASK P-3 Assess organization-wide security and privacy risk and update the risk assessment
Abbreviation
results on an ongoing basis.
Prepare Step
Task 3 Potential Inputs: Risk management strategy; mission or business objectives; current threat
...
Expected Outputs: Organization-level risk assessment results. after task execution
...
and business process, and information system levels of the organization to help prepare the
...
organizational operations, organizational assets, individuals, other organizations, and the Nation. The risk
...
to protect information commensurate with risk. Organizations can use tailored baselines and overlays to
...
prioritized list of cybersecurity outcomes developed at the organization and mission/business process
...
Mission/business process cons iderations are addressed in the RMF Prepare-Organization Level
...
of the associated security and privacy architectures. Information is elicited from stakeholders to acquire a
...
programs collaborate to develop a common understanding of authorization boundaries. To conduct
...
system element, or service could create a loss, and the potential impact of that loss. The impact may be
...
including a strategy for collaborating with providers on supply chain risk assessments. Such collaboration
...
needs. Protection needs include the security characteristics70 of the system and the security behavior of
...
that are more transparent and therefore, easier to understand and protect. Enterprise architecture also
...
added to or updated in the system description as it becomes available during the system life cycle, during
...
additional controls; and providing specification information for control implementation.77 Organizations
...
inventory; relevant laws, executive orders, directives, regulations, and policies.
...
the organization and provide a protection capability that is partially inherited by one or more systems.
...
assessment. The approach to control assessments during continuous monitoring may include reuse of
...
including systems security and privacy engineering methodologies, concepts, and principles. Risk
...
Organizations also address, where applicable, assurance requirements when implementing controls.
Assurance requirements are directed at the activities that control developers and implementers carry out
...
System Development Life Cycle Phase: New – Development/Acquisition; Implementation/Assessment.
Existing – Operations/Maintenance.
Discussion: Organizations consider both the technical expertise and level of independence87 required in
...
correcting deficiencies in the implemented controls, are documented in the assessment reports92 by
...
supply chain risks) that result from the operation the system or the use of common controls.
...
is reviewed by the authorizing official to ensure there is agreement with the remediation actions planned
...
At the completion of the control reassessments, security and privacy plans contain an accurate
...
If control assessments are conducted by qualified assessors with the level of independence104 required,
...
consult with the senior accountable official for risk management or risk executive (function), senior
...
Ap pendix B provides definitions for terminology used within Special Publication 800-37.
...
Th e following sections describe the roles and responsibilities of key participants involved in
...
• Chief Information Officer Official Designated Representative
Risk Management Roles
...
Risk Assessment—Organization
(Function) Official Designated Representative
...
• Senior Accountable Official for Risk • Authorizing Official or Authorizing
Organizationally-Tailored
Management or Risk Executive Official Designated Representative
Control Baselines and
(Function) • Senior Agency Information Security
...
Officer • Senior Accountable Official for Risk
Common Control Identification
...
(Function) • Senior Agency Official for Privacy
(Optional)
• Mission or Business Owner
...
Management or Risk Executive • Senior Agency Information Security
...
Mission or Business Focus
• System Owner
Identify the missions, business • Information Owner or Steward
...
• Information Owner or Steward • System Privacy Officer
Information Types
• Mission or Business Owner
...
Risk Assessment—System
• System Privacy Officer (Function)
...
Requirements Definition
• Information Owner or Steward • Senior Agency Information Security
Define the security and privacy • System Privacy Officer Officer
...
• Enterprise Architect • Authorizing Official or Authorizing
Enterprise Architecture
• Security Architect Official Designated Representative
Determine the placement of the • Privacy Architect • Senior Agency Information Security
...
• Privacy Architect • Authorizing Official or Authorizing
Requirements Allocation
...
• Information Owner or Steward Management or Risk Executive
Security Categorization
(Function)
Categorize the system and • Chief Information Officer
document the security • Senior Agency Information Security
...
Review and approve the security (for systems processing PII) • Senior Agency Information Security
...
RMF TASKS PRIMARY RESPONSIBILITY SUPPORTING ROLES
TASK I-1 • System Owner • Information Owner or Steward
• Common Control Provider • Security Architect
Control Implementation
• Privacy Architect
...
Assessment Plan
• Control Assessor • Senior Agency Official for Privacy
...
• Common Control Provider Official Designated Representative
Remediation Actions
• Control Assessor • Senior Agency Information Security
...
Official Designated Representative Control Provider
Authorization Reporting
• Information Owner or Steward
...
System and Environment Changes
• Senior Agency Information (Function)
Monitor the information system Security Officer • Authorizing Official or Authorizing
and its environment of operation • Senior Agency Official for Privacy Official Designated Representative
...
• System Owner Management or Risk Executive
Ongoing Risk Response
...
• System Privacy Officer
actions when a system is removed • Senior Accountable Official for Risk
from operation.
Management or Risk Executive
(Function)
• Senior Agency Information Security
...
Th is appendix provides information on the system and common control authorization
...
** An ATU requires a completed implemented within a system as Authorizing
ATO by the organization
hardware, software, or firmware Official
providing the shared or cloud
components.
system, service, or application.
AUTHORIZATION TO USE**
Shared and Cloud System s, Services, Applications
...
Th is appendix provides additional considerations for determining authorization boundaries
...
Al l systems, including operational systems, systems under development, and systems that
